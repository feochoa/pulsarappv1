...
public abstract class AttrSettingSwitchView extends LinearLayout {
    private static final String TAG = "ScanJni JDScan";
    ...
    public AttrSettingSwitchView(Context context, String codeName) {
        super(context);
        mCodeName = codeName;
    ...
    public AttrSettingSwitchView(Context context, AttributeSet attrs, String codeName) {
        super(context, attrs);
        initView(context);
    }
